...
# admissible, admissibility_problems = check_heuristic_admissibility(
#     graph, CITY_POSITIONS, goal, HEURISTIC_SCALE
# )
# consistent, consistency_problems = check_heuristic_consistency(
#     graph, CITY_POSITIONS, goal, HEURISTIC_SCALE
# )
...
#     if not admissible:
#         st.dataframe(
#             pd.DataFrame(admissibility_problems),
#             use_container_width=True,
#             hide_index=True,
#         )
...
#     if not consistent:
#         st.dataframe(
#             pd.DataFrame(consistency_problems),
#             use_container_width=True,
#             hide_index=True,
#         )
